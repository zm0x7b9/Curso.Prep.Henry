...
function promedioResultadosTest(resultadosTest) {
  ...
  promedioPuntajes = sumaResultados / resultadosTest.length;
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
var cadenaPrimerDig = n.toString();
var primerDig = cadenaPrimerDig.substr(0, 1);
if(primerDig === '9') {
  return(true);
} else {
return(false);
